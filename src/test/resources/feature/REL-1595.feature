@ST_103448 @tagtagtag @this_is_story_tag
...
@SC_447107 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_447108 @third_scenario_tag
...
@SC_447109 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_447110 @fifth_scenario_tag
