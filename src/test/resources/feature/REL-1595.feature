@ST_75011 @tagtagtag @this_is_story_tag
...
@SC_335689 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335690 @third_scenario_tag
...
@SC_335691 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335692 @fifth_scenario_tag
