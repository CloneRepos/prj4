@ST_78985 @tagtagtag @this_is_story_tag
...
@SC_350677 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350678 @third_scenario_tag
...
@SC_350679 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350680 @fifth_scenario_tag
