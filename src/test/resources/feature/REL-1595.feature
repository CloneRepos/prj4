@ST_99288 @tagtagtag @this_is_story_tag
...
@SC_430783 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_430784 @third_scenario_tag
...
@SC_430785 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_430786 @fifth_scenario_tag
