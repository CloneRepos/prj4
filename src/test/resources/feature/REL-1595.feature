@ST_40196 @tagtagtag @this_is_story_tag
...
@SC_198419 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198420 @third_scenario_tag
...
@SC_198421 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198422 @fifth_scenario_tag
