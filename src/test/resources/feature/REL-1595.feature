@ST_41140 @tagtagtag @this_is_story_tag
...
@SC_202055 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_202056 @third_scenario_tag
...
@SC_202057 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_202058 @fifth_scenario_tag
