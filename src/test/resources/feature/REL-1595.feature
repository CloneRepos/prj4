@ST_38393 @tagtagtag @this_is_story_tag
...
@SC_189862 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189863 @third_scenario_tag
...
@SC_189864 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189865 @fifth_scenario_tag
