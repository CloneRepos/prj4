@ST_64267 @tagtagtag @this_is_story_tag
...
@SC_291783 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_291784 @third_scenario_tag
...
@SC_291785 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_291786 @fifth_scenario_tag
