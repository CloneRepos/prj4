@ST_36123 @tagtagtag @this_is_story_tag
...
@SC_182307 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_182308 @third_scenario_tag
...
@SC_182309 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_182310 @fifth_scenario_tag
