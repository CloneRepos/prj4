@ST_84612 @tagtagtag @this_is_story_tag
...
@SC_373010 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_373011 @third_scenario_tag
...
@SC_373012 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_373013 @fifth_scenario_tag
