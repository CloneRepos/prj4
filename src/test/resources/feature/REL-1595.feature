@ST_33634 @tagtagtag @this_is_story_tag
...
@SC_174078 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_174079 @third_scenario_tag
...
@SC_174080 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_174081 @fifth_scenario_tag
