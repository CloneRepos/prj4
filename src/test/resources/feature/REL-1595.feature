@ST_53002 @tagtagtag @this_is_story_tag
...
@SC_251212 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251213 @third_scenario_tag
...
@SC_251214 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251215 @fifth_scenario_tag
