@ST_50444 @tagtagtag @this_is_story_tag
...
@SC_238795 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238796 @third_scenario_tag
...
@SC_238797 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238798 @fifth_scenario_tag
