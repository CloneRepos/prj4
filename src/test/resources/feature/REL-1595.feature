@ST_86176 @tagtagtag @this_is_story_tag
...
@SC_379158 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_379159 @third_scenario_tag
...
@SC_379160 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_379161 @fifth_scenario_tag
