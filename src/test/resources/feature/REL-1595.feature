@ST_120169 @tagtagtag @this_is_story_tag
...
@SC_511252 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_511253 @third_scenario_tag
...
@SC_511254 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_511255 @fifth_scenario_tag
