@ST_67096 @tagtagtag @this_is_story_tag
...
@SC_304208 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304209 @third_scenario_tag
...
@SC_304210 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304211 @fifth_scenario_tag
