@ST_34482 @tagtagtag @this_is_story_tag
...
@SC_177333 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177334 @third_scenario_tag
...
@SC_177335 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177336 @fifth_scenario_tag
