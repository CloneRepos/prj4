@ST_111840 @tagtagtag @this_is_story_tag
...
@SC_478470 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_478471 @third_scenario_tag
...
@SC_478472 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_478473 @fifth_scenario_tag
