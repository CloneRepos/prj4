@ST_75501 @tagtagtag @this_is_story_tag
...
@SC_337453 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_337454 @third_scenario_tag
...
@SC_337455 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_337456 @fifth_scenario_tag
