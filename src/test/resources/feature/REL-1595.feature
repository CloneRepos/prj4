@ST_108376 @tagtagtag @this_is_story_tag
...
@SC_465230 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_465231 @third_scenario_tag
...
@SC_465232 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_465233 @fifth_scenario_tag
