@ST_17208 @tagtagtag @this_is_story_tag
...
@SC_108459 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_108460 @third_scenario_tag
...
@SC_108461 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_108462 @fifth_scenario_tag
