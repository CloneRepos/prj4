@ST_117045 @tagtagtag @this_is_story_tag
...
@SC_498960 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_498961 @third_scenario_tag
...
@SC_498962 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_498963 @fifth_scenario_tag
