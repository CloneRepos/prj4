@ST_79407 @tagtagtag @this_is_story_tag
...
@SC_351939 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_351940 @third_scenario_tag
...
@SC_351941 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_351942 @fifth_scenario_tag
