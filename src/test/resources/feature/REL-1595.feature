@ST_63840 @tagtagtag @this_is_story_tag
...
@SC_290523 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290524 @third_scenario_tag
...
@SC_290525 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290526 @fifth_scenario_tag
