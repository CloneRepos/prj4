@ST_42403 @tagtagtag @this_is_story_tag
...
@SC_207528 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207529 @third_scenario_tag
...
@SC_207530 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207531 @fifth_scenario_tag
