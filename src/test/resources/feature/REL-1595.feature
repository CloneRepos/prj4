@ST_106386 @tagtagtag @this_is_story_tag
...
@SC_457823 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457824 @third_scenario_tag
...
@SC_457825 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457826 @fifth_scenario_tag
