@ST_48815 @tagtagtag @this_is_story_tag
...
@SC_233230 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_233231 @third_scenario_tag
...
@SC_233232 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_233233 @fifth_scenario_tag
