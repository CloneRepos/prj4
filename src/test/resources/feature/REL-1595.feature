@ST_37816 @tagtagtag @this_is_story_tag
...
@SC_187353 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_187354 @third_scenario_tag
...
@SC_187355 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_187356 @fifth_scenario_tag
