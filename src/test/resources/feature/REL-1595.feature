@ST_110366 @tagtagtag @this_is_story_tag
...
@SC_472637 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_472638 @third_scenario_tag
...
@SC_472639 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_472640 @fifth_scenario_tag
