@ST_49321 @tagtagtag @this_is_story_tag
...
@SC_234802 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_234803 @third_scenario_tag
...
@SC_234804 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_234805 @fifth_scenario_tag
