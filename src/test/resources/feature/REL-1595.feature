@ST_62108 @tagtagtag @this_is_story_tag
...
@SC_284258 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284259 @third_scenario_tag
...
@SC_284260 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284261 @fifth_scenario_tag
