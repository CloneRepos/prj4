@ST_125271 @tagtagtag @this_is_story_tag
...
@SC_530841 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_530842 @third_scenario_tag
...
@SC_530843 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_530844 @fifth_scenario_tag
