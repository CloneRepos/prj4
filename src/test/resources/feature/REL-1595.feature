@ST_71636 @tagtagtag @this_is_story_tag
...
@SC_322714 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_322715 @third_scenario_tag
...
@SC_322716 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_322717 @fifth_scenario_tag
