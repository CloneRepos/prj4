@ST_77775 @tagtagtag @this_is_story_tag
...
@SC_345771 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_345772 @third_scenario_tag
...
@SC_345773 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_345774 @fifth_scenario_tag
