@ST_15062 @tagtagtag @this_is_story_tag
...
@SC_97146 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_97147 @third_scenario_tag
...
@SC_97148 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_97149 @fifth_scenario_tag
