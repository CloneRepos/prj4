@ST_118607 @tagtagtag @this_is_story_tag
...
@SC_505106 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_505107 @third_scenario_tag
...
@SC_505108 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_505109 @fifth_scenario_tag
