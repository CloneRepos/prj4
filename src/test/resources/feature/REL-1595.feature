@ST_94700 @tagtagtag @this_is_story_tag
...
@SC_413187 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_413188 @third_scenario_tag
...
@SC_413189 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_413190 @fifth_scenario_tag
