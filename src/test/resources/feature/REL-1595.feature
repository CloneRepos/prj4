@ST_82123 @tagtagtag @this_is_story_tag
...
@SC_362485 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_362486 @third_scenario_tag
...
@SC_362487 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_362488 @fifth_scenario_tag
