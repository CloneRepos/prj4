@ST_33198 @tagtagtag @this_is_story_tag
...
@SC_172775 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_172776 @third_scenario_tag
...
@SC_172777 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_172778 @fifth_scenario_tag
