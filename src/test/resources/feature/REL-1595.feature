@ST_95648 @tagtagtag @this_is_story_tag
...
@SC_416496 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_416497 @third_scenario_tag
...
@SC_416498 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_416499 @fifth_scenario_tag
