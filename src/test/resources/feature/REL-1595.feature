@ST_97204 @tagtagtag @this_is_story_tag
...
@SC_422587 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_422588 @third_scenario_tag
...
@SC_422589 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_422590 @fifth_scenario_tag
