@ST_115482 @tagtagtag @this_is_story_tag
...
@SC_492813 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492814 @third_scenario_tag
...
@SC_492815 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492816 @fifth_scenario_tag
