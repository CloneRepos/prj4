@ST_11152 @tagtagtag @this_is_story_tag
...
@SC_73198 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73199 @third_scenario_tag
...
@SC_73200 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73201 @fifth_scenario_tag
