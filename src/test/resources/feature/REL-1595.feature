@ST_76223 @tagtagtag @this_is_story_tag
...
@SC_340461 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_340462 @third_scenario_tag
...
@SC_340463 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_340464 @fifth_scenario_tag
