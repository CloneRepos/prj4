@ST_92710 @tagtagtag @this_is_story_tag
...
@SC_405780 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_405781 @third_scenario_tag
...
@SC_405782 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_405783 @fifth_scenario_tag
