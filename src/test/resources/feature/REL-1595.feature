@ST_61088 @tagtagtag @this_is_story_tag
...
@SC_280974 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_280975 @third_scenario_tag
...
@SC_280976 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_280977 @fifth_scenario_tag
