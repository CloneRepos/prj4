@ST_39749 @tagtagtag @this_is_story_tag
...
@SC_196950 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_196951 @third_scenario_tag
...
@SC_196952 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_196953 @fifth_scenario_tag
