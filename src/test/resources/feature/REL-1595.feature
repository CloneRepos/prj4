@ST_122246 @tagtagtag @this_is_story_tag
...
@SC_519392 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_519393 @third_scenario_tag
...
@SC_519394 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_519395 @fifth_scenario_tag
