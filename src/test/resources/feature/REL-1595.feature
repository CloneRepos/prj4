@ST_8936 @tagtagtag @this_is_story_tag
...
@SC_61396 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61397 @third_scenario_tag
...
@SC_61398 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61399 @fifth_scenario_tag
