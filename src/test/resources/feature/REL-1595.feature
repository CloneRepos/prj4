@ST_108897 @tagtagtag @this_is_story_tag
...
@SC_467279 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467280 @third_scenario_tag
...
@SC_467281 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467282 @fifth_scenario_tag
