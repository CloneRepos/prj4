@ST_73735 @tagtagtag @this_is_story_tag
...
@SC_330288 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_330289 @third_scenario_tag
...
@SC_330290 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_330291 @fifth_scenario_tag
