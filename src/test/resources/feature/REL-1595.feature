@ST_109418 @tagtagtag @this_is_story_tag
...
@SC_469328 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469329 @third_scenario_tag
...
@SC_469330 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469331 @fifth_scenario_tag
