@ST_36972 @tagtagtag @this_is_story_tag
...
@SC_184831 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184832 @third_scenario_tag
...
@SC_184833 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184834 @fifth_scenario_tag
