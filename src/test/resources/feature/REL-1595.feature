@ST_65516 @tagtagtag @this_is_story_tag
...
@SC_297166 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_297167 @third_scenario_tag
...
@SC_297168 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_297169 @fifth_scenario_tag
