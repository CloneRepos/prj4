@ST_109939 @tagtagtag @this_is_story_tag
...
@SC_471377 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_471378 @third_scenario_tag
...
@SC_471379 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_471380 @fifth_scenario_tag
