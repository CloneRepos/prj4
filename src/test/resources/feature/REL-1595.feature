@ST_35691 @tagtagtag @this_is_story_tag
...
@SC_181044 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_181045 @third_scenario_tag
...
@SC_181046 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_181047 @fifth_scenario_tag
