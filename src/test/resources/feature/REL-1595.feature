@ST_66372 @tagtagtag @this_is_story_tag
...
@SC_301079 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_301080 @third_scenario_tag
...
@SC_301081 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_301082 @fifth_scenario_tag
