@ST_61358 @tagtagtag @this_is_story_tag
...
@SC_282548 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282549 @third_scenario_tag
...
@SC_282550 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282551 @fifth_scenario_tag
