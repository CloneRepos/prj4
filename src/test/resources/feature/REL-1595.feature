@ST_85134 @tagtagtag @this_is_story_tag
...
@SC_375060 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_375061 @third_scenario_tag
...
@SC_375062 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_375063 @fifth_scenario_tag
