@ST_62566 @tagtagtag @this_is_story_tag
...
@SC_286438 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_286439 @third_scenario_tag
...
@SC_286440 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_286441 @fifth_scenario_tag
