@ST_45369 @tagtagtag @this_is_story_tag
...
@SC_220211 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220212 @third_scenario_tag
...
@SC_220213 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220214 @fifth_scenario_tag
