@ST_123809 @tagtagtag @this_is_story_tag
...
@SC_525539 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525540 @third_scenario_tag
...
@SC_525541 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525542 @fifth_scenario_tag
