@ST_119648 @tagtagtag @this_is_story_tag
...
@SC_509203 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_509204 @third_scenario_tag
...
@SC_509205 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_509206 @fifth_scenario_tag
