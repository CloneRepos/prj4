@ST_82651 @tagtagtag @this_is_story_tag
...
@SC_364590 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364591 @third_scenario_tag
...
@SC_364592 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364593 @fifth_scenario_tag
