@ST_86696 @tagtagtag @this_is_story_tag
...
@SC_381206 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_381207 @third_scenario_tag
...
@SC_381208 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_381209 @fifth_scenario_tag
