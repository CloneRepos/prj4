@ST_11806 @tagtagtag @this_is_story_tag
...
@SC_78306 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78307 @third_scenario_tag
...
@SC_78308 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78309 @fifth_scenario_tag
