@ST_47243 @tagtagtag @this_is_story_tag
...
@SC_227444 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227445 @third_scenario_tag
...
@SC_227446 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227447 @fifth_scenario_tag
