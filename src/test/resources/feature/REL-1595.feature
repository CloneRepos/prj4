@ST_41886 @tagtagtag @this_is_story_tag
...
@SC_205515 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_205516 @third_scenario_tag
...
@SC_205517 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_205518 @fifth_scenario_tag
