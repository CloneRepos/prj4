@ST_63161 @tagtagtag @this_is_story_tag
...
@SC_288324 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_288325 @third_scenario_tag
...
@SC_288326 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_288327 @fifth_scenario_tag
