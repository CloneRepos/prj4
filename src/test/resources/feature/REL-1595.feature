@ST_88556 @tagtagtag @this_is_story_tag
...
@SC_389511 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389512 @third_scenario_tag
...
@SC_389513 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389514 @fifth_scenario_tag
