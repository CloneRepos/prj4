@ST_72064 @tagtagtag @this_is_story_tag
...
@SC_323979 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_323980 @third_scenario_tag
...
@SC_323981 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_323982 @fifth_scenario_tag
