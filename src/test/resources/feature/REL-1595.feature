@ST_37394 @tagtagtag @this_is_story_tag
...
@SC_186091 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_186092 @third_scenario_tag
...
@SC_186093 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_186094 @fifth_scenario_tag
