@ST_69265 @tagtagtag @this_is_story_tag
...
@SC_312914 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312915 @third_scenario_tag
...
@SC_312916 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312917 @fifth_scenario_tag
