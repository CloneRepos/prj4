@ST_96683 @tagtagtag @this_is_story_tag
...
@SC_420538 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420539 @third_scenario_tag
...
@SC_420540 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420541 @fifth_scenario_tag
