@ST_118086 @tagtagtag @this_is_story_tag
...
@SC_503057 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_503058 @third_scenario_tag
...
@SC_503059 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_503060 @fifth_scenario_tag
