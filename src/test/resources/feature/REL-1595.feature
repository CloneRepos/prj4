@ST_116524 @tagtagtag @this_is_story_tag
...
@SC_496911 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_496912 @third_scenario_tag
...
@SC_496913 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_496914 @fifth_scenario_tag
