@ST_12923 @tagtagtag @this_is_story_tag
...
@SC_82615 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_82616 @third_scenario_tag
...
@SC_82617 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_82618 @fifth_scenario_tag
