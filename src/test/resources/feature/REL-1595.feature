@ST_57402 @tagtagtag @this_is_story_tag
...
@SC_267439 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_267440 @third_scenario_tag
...
@SC_267441 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_267442 @fifth_scenario_tag
