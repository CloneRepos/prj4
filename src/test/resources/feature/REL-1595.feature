@ST_44173 @tagtagtag @this_is_story_tag
...
@SC_214668 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214669 @third_scenario_tag
...
@SC_214670 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214671 @fifth_scenario_tag
