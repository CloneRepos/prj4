@ST_112356 @tagtagtag @this_is_story_tag
...
@SC_480519 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_480520 @third_scenario_tag
...
@SC_480521 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_480522 @fifth_scenario_tag
