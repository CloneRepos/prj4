@ST_49765 @tagtagtag @this_is_story_tag
...
@SC_236595 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236596 @third_scenario_tag
...
@SC_236597 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236598 @fifth_scenario_tag
