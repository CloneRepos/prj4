@ST_92189 @tagtagtag @this_is_story_tag
...
@SC_403731 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403732 @third_scenario_tag
...
@SC_403733 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403734 @fifth_scenario_tag
