@ST_104490 @tagtagtag @this_is_story_tag
...
@SC_451205 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_451206 @third_scenario_tag
...
@SC_451207 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_451208 @fifth_scenario_tag
