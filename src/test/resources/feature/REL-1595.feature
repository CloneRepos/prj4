@ST_122767 @tagtagtag @this_is_story_tag
...
@SC_521441 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_521442 @third_scenario_tag
...
@SC_521443 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_521444 @fifth_scenario_tag
