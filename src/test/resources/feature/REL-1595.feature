@ST_117565 @tagtagtag @this_is_story_tag
...
@SC_501008 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_501009 @third_scenario_tag
...
@SC_501010 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_501011 @fifth_scenario_tag
