@ST_107334 @tagtagtag @this_is_story_tag
...
@SC_461132 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_461133 @third_scenario_tag
...
@SC_461134 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_461135 @fifth_scenario_tag
