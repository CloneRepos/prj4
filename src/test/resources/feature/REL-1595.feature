@ST_56317 @tagtagtag @this_is_story_tag
...
@SC_263960 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_263961 @third_scenario_tag
...
@SC_263962 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_263963 @fifth_scenario_tag
