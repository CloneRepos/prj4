@ST_36550 @tagtagtag @this_is_story_tag
...
@SC_183569 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183570 @third_scenario_tag
...
@SC_183571 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183572 @fifth_scenario_tag
