@ST_85655 @tagtagtag @this_is_story_tag
...
@SC_377109 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_377110 @third_scenario_tag
...
@SC_377111 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_377112 @fifth_scenario_tag
