@ST_81053 @tagtagtag @this_is_story_tag
...
@SC_358120 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_358121 @third_scenario_tag
...
@SC_358122 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_358123 @fifth_scenario_tag
