@ST_91147 @tagtagtag @this_is_story_tag
...
@SC_399633 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_399634 @third_scenario_tag
...
@SC_399635 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_399636 @fifth_scenario_tag
