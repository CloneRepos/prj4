@ST_43623 @tagtagtag @this_is_story_tag
...
@SC_212491 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_212492 @third_scenario_tag
...
@SC_212493 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_212494 @fifth_scenario_tag
