@ST_112877 @tagtagtag @this_is_story_tag
...
@SC_482568 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_482569 @third_scenario_tag
...
@SC_482570 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_482571 @fifth_scenario_tag
