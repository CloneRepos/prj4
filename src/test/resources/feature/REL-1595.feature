@ST_119127 @tagtagtag @this_is_story_tag
...
@SC_507154 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_507155 @third_scenario_tag
...
@SC_507156 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_507157 @fifth_scenario_tag
