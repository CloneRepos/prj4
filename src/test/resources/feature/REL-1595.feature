@ST_32183 @tagtagtag @this_is_story_tag
...
@SC_168910 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168911 @third_scenario_tag
...
@SC_168912 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168913 @fifth_scenario_tag
