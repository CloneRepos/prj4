@ST_14187 @tagtagtag @this_is_story_tag
...
@SC_90771 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_90772 @third_scenario_tag
...
@SC_90773 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_90774 @fifth_scenario_tag
