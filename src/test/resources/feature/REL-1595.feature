@ST_96162 @tagtagtag @this_is_story_tag
...
@SC_418489 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418490 @third_scenario_tag
...
@SC_418491 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418492 @fifth_scenario_tag
