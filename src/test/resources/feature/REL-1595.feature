@ST_74293 @tagtagtag @this_is_story_tag
...
@SC_332705 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332706 @third_scenario_tag
...
@SC_332707 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332708 @fifth_scenario_tag
