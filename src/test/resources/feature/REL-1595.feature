@ST_121725 @tagtagtag @this_is_story_tag
...
@SC_517343 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_517344 @third_scenario_tag
...
@SC_517345 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_517346 @fifth_scenario_tag
