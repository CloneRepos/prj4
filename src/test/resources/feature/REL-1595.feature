@ST_44784 @tagtagtag @this_is_story_tag
...
@SC_217614 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_217615 @third_scenario_tag
...
@SC_217616 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_217617 @fifth_scenario_tag
