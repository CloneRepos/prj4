@ST_93231 @tagtagtag @this_is_story_tag
...
@SC_407829 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_407830 @third_scenario_tag
...
@SC_407831 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_407832 @fifth_scenario_tag
