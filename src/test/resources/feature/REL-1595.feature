@ST_120690 @tagtagtag @this_is_story_tag
...
@SC_513301 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_513302 @third_scenario_tag
...
@SC_513303 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_513304 @fifth_scenario_tag
