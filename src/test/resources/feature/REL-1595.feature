@ST_80525 @tagtagtag @this_is_story_tag
...
@SC_355973 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_355974 @third_scenario_tag
...
@SC_355975 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_355976 @fifth_scenario_tag
