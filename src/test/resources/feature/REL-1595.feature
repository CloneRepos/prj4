@ST_101371 @tagtagtag @this_is_story_tag
...
@SC_438966 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_438967 @third_scenario_tag
...
@SC_438968 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_438969 @fifth_scenario_tag
