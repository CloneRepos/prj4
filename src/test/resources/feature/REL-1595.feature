@ST_59065 @tagtagtag @this_is_story_tag
...
@SC_273765 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_273766 @third_scenario_tag
...
@SC_273767 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_273768 @fifth_scenario_tag
