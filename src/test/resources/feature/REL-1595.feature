@ST_57824 @tagtagtag @this_is_story_tag
...
@SC_268698 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268699 @third_scenario_tag
...
@SC_268700 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268701 @fifth_scenario_tag
