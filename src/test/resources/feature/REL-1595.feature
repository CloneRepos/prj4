@ST_46648 @tagtagtag @this_is_story_tag
...
@SC_225554 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225555 @third_scenario_tag
...
@SC_225556 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225557 @fifth_scenario_tag
