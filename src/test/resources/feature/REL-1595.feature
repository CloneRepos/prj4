@ST_56670 @tagtagtag @this_is_story_tag
...
@SC_264604 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264605 @third_scenario_tag
...
@SC_264606 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264607 @fifth_scenario_tag
