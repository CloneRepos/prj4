@ST_89070 @tagtagtag @this_is_story_tag
...
@SC_391505 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_391506 @third_scenario_tag
...
@SC_391507 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_391508 @fifth_scenario_tag
