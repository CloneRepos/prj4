@ST_72592 @tagtagtag @this_is_story_tag
...
@SC_326084 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_326085 @third_scenario_tag
...
@SC_326086 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_326087 @fifth_scenario_tag
