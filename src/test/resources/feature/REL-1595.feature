@ST_32737 @tagtagtag @this_is_story_tag
...
@SC_171312 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_171313 @third_scenario_tag
...
@SC_171314 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_171315 @fifth_scenario_tag
