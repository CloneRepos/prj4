@ST_61678 @tagtagtag @this_is_story_tag
...
@SC_282860 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282861 @third_scenario_tag
...
@SC_282862 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282863 @fifth_scenario_tag
