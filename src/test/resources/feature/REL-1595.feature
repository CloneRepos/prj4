@ST_81602 @tagtagtag @this_is_story_tag
...
@SC_360436 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_360437 @third_scenario_tag
...
@SC_360438 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_360439 @fifth_scenario_tag
