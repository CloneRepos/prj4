@ST_51619 @tagtagtag @this_is_story_tag
...
@SC_244770 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244771 @third_scenario_tag
...
@SC_244772 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244773 @fifth_scenario_tag
