@ST_76650 @tagtagtag @this_is_story_tag
...
@SC_341721 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341722 @third_scenario_tag
...
@SC_341723 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341724 @fifth_scenario_tag
