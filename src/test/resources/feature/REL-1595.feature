@ST_83981 @tagtagtag @this_is_story_tag
...
@SC_369931 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369932 @third_scenario_tag
...
@SC_369933 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369934 @fifth_scenario_tag
