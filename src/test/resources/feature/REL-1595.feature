@ST_90626 @tagtagtag @this_is_story_tag
...
@SC_397584 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_397585 @third_scenario_tag
...
@SC_397586 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_397587 @fifth_scenario_tag
