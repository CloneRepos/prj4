@ST_100330 @tagtagtag @this_is_story_tag
...
@SC_434881 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434882 @third_scenario_tag
...
@SC_434883 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434884 @fifth_scenario_tag
