@ST_114961 @tagtagtag @this_is_story_tag
...
@SC_490764 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_490765 @third_scenario_tag
...
@SC_490766 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_490767 @fifth_scenario_tag
