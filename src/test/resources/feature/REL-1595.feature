@ST_87916 @tagtagtag @this_is_story_tag
...
@SC_386406 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386407 @third_scenario_tag
...
@SC_386408 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386409 @fifth_scenario_tag
