@ST_105532 @tagtagtag @this_is_story_tag
...
@SC_455303 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_455304 @third_scenario_tag
...
@SC_455305 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_455306 @fifth_scenario_tag
