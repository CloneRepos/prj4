@ST_73307 @tagtagtag @this_is_story_tag
...
@SC_329028 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_329029 @third_scenario_tag
...
@SC_329030 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_329031 @fifth_scenario_tag
