@ST_98246 @tagtagtag @this_is_story_tag
...
@SC_426685 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_426686 @third_scenario_tag
...
@SC_426687 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_426688 @fifth_scenario_tag
