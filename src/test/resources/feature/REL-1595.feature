@ST_123288 @tagtagtag @this_is_story_tag
...
@SC_523490 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523491 @third_scenario_tag
...
@SC_523492 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523493 @fifth_scenario_tag
